...
def run_model(epochs, scheme, conditioning, inverse, filename):
    ...
    utils.train()
    utils.plot_save_results(path='Outputs/pinn_results01.10', filename=filename)
...
if __name__ == "__main__":
    ...
    filename = 'forward_relobralo.svg'
    run_model(epochs=epochs, scheme='relobralo', conditioning=True, inverse=False, filename=filename)
